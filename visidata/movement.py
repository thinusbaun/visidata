...
Sheet.addCommand(None, 'go-pagedown', 'cursorDown(nScreenRows-1);', 'scroll one page forward'),
Sheet.addCommand(None, 'go-pageup', 'cursorDown(-nScreenRows+1);', 'scroll one page backward'),
